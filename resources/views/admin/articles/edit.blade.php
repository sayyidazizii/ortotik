            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                ...
                <div class="flex-1 space-y-3 w-full">
                    <div>
                        ...
                        <p class="text-[11px] text-slate-400 mt-1">Format: JPG, PNG, WEBP (Maks. 5MB). Kosongkan jika tidak ingin mengubah foto sampul.</p>
                    </div>

                    <div class="pt-2 border-t border-slate-200/60">
                        <label class="block text-[11px] font-bold text-slate-600 mb-1">Atau Ubah URL Gambar</label>
                        <input type="text" name="thumbnail" x-model="imagePreview" value="{{ old('thumbnail', $article->thumbnail) }}" placeholder="https://images.unsplash.com/... atau /images/..."

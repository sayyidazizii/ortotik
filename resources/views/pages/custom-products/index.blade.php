...
@php
    ...
    if (empty($flowSteps)) {
        $flowSteps = [
            ...
            ['step' => '05', 'title' => 'Rektifikasi', 'sub' => 'rectification', 'icon' => 'tune', 'desc' => 'Modifikasi dan penyesuaian model cetakan positif gips untuk distribusi tumpuan beban (weight-bearing) dan koreksi biomekanik.'],

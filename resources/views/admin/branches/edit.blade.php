...
<div class="max-w-3xl space-y-6" x-data="{
    ...
    <form action="{{ route('admin.branches.update', $branch->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-4">
            <div class="flex items-center gap-2 text-medical-600">
                ...
                <h3 class="text-xs font-bold uppercase tracking-wider text-slate-800">Upload / Ganti Foto Cabang</h3>
            </div>

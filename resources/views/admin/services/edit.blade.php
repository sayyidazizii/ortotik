...
<div class="max-w-3xl space-y-6" x-data="{
    ...
    <form action="{{ route('admin.services.update', $service->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-4">
            <div class="flex items-center gap-2 text-medical-600">
                ...
                <h3 class="text-xs font-bold uppercase tracking-wider text-slate-800">Upload / Ganti Foto Layanan Medis</h3>
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                ...
                <div class="flex-1 space-y-3 w-full">
                    ...
                    <div class="pt-2 border-t border-slate-200/60">
                        ...
                        <input type="text" name="thumbnail" x-model="imagePreview" value="{{ old('thumbnail', $service->thumbnail) }}" placeholder="https://... atau /images/..."

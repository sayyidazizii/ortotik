...
@php
    ...
    if (empty($initialPatientFlow)) {
        $initialPatientFlow = [
            ...
            ['step' => '04', 'title' => 'Pencetakan', 'sub' => 'casting', 'icon' => 'view_in_ar', 'desc' => 'Pengambilan cetakan negatif anatomi tubuh pasien menggunakan casting gips medis (Plaster of Paris) secara presisi.'],
            ['step' => '05', 'title' => 'Rektifikasi', 'sub' => 'rectification', 'icon' => 'architecture', 'desc' => 'Modifikasi dan penyelarasan model cetakan positif gips untuk mendistribusikan tekanan secara biomekanis benar pada area sensitif dan area penumpu beban.'],
